...
public class Date_go extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //calendarView.addDecorators(new (this));

        // 좌우 화살표 가운데의 연/월이 보이는 방식 커스텀 (지금 그렇게 필요한게 아니니깐 나중에 추가를 해보자 ^^ (오류뜸)
//        calendarView.setTitleFormatter(new.addDecorators TitleFormatter() {
//            @Override
